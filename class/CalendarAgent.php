...
class CalendarAgent{
  ...
  var $dbPwd="admin";
  var $dbName ="jobenfance";
  var $dbPrefix = 'llx_axagenda_';
  var $DOCUMENT_ROOT = "";
  var $hanlde = NULL;
  /*
  ...
  function loadEvent($params){
	...
	error_log('obj subject <'.utf8_encode($obj->{'subject'}).'>');
	error_log('obj description <'.utf8_encode($obj->{'description'}).'>');

	$obj->{'subject'}     = utf8_encode($obj->{'subject'});
	$obj->{'description'} = utf8_encode($obj->{'description'});
