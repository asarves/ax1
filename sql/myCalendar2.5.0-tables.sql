...
CREATE TABLE IF NOT EXISTS `ax_calendar_event` (
...
CREATE TABLE IF NOT EXISTS `ax_calendar_event_reminder` (
...
CREATE TABLE IF NOT EXISTS `ax_calendar_setting` (
...
INSERT INTO `ax_calendar_setting` (`userId`, `hourFormat`, `dayFormat`, `weekFormat`, `monthFormat`, `fromtoFormat`, `activeStartTime`, `activeEndTime`, `createByDblclick`, `hideInactiveRow`, `singleDay`, `language`, `intervalSlot`, `startDay`, `readOnly`, `initialView`) VALUES
(1, '24', 'l M d Y', 'm/d(D)', 'm/d', 'm/d/Y', '09:00', '19:00', 0, 0, 0, 'en', 30, '0', 0, 1);


CREATE TABLE IF NOT EXISTS `ax_calendar_type` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `userId` int(255) NOT NULL,
...
INSERT INTO `ax_user` (`id`, `description`, `email`, `email_show`, `enabled`, `first_name`, `last_name`, `passwd`, `username`) VALUES
