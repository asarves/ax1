...
//		}else{  
		    ...
		    this.cleanup();
		    console.log("LoadEvent from DayView");
	usertodoValues = Ext.usertodoValues;
		eh.ds.loadEvent(startDate, endDate, usertodoValues, function(eventSet) {
//	    console.log("onLoadUserEvents success");
		    // var cc = this.mainPanel.calendarContainer;
            var cview = this; //cc.currentView;
	    cview.fireEvent('beforeremoteload');
	    ...
	    var wlist = eventSet['whole'];
	    // glayout.wholeList['whole'] = [];
		    eh.calendarLayout.updateWholeList(wlist, 'replace');
	    cview.showEvents(eventSet, true);
	    cview.fireEvent('remoteload');
            // this.calendarLayout.resetLayout({
            //     hideCalendar:true,
            ...
            // this.fireEvent('changeEventCache', this);
	      	    ...
	      	    // eh.ds.loadEvent(startDate, endDate, undefined, function(eventSet){   
