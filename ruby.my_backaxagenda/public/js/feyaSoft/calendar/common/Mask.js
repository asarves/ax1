...
Ext.ux.calendar.Mask = {
    ...
    // f0ff06
    // FC4305
    colors:['76aabd', 'D96666', '59BFB3', 'F2A442', '4CB052', 'B373B3', 'E01B1B', '040480', 'FC4305', '000000', '5B5B5B'],

    colorIndex:["bleu", "rouge", "cyan", "orange", "vert", "parme", "rougevif", "bleumarine", "jaune", "black", "gris"],
    ...
    getEventStore : function(url,pageSize, text) {
